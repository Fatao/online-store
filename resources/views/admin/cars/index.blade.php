...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('admin.cars.create') }}" class="btn btn-sm btn-gold">+ Добавить автомобиль</a>
    </div>
    <div class="card-body border-bottom" style="padding:12px 20px;">
        <form action="{{ route('admin.cars.index') }}" method="GET" class="d-flex" style="gap:8px;">
                    ...
                    <tr style="vertical-align:middle;">
                        <td>
                            @if($car->image)
                                ...
                                <div style="display:none;width:52px;height:40px;background:#1e1e20;border-radius:4px;border:1px solid #2a2a2c;align-items:center;justify-content:center;font-size:1.1rem;">🚗</div>
                            @else
